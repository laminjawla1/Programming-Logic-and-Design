...
commission_at_purchase = 0.02 * total_at_purchase

shares_at_sale = 1000
unit_price_at_sale = 33.92
total_at_sale = shares_at_sale * unit_price_at_sale
commission_at_sale = 0.02 * total_at_sale

amount_paid_for_stocks = total_at_purchase + commission_at_purchase
stocks_sold_for = total_at_sale - commission_at_sale

print("Joe paid for stock:", amount_paid_for_stocks)
print("Commission Paid at purchase:", commission_at_purchase)
print("Joe sold stock for:", stocks_sold_for)
print("Commission at sale:", commission_at_sale)
print("Profit or Loss:", stocks_sold_for - amount_paid_for_stocks)
